...
import { Mail, MessageSquare, HelpCircle, ChevronDown, Sparkles, Send, MapPin } from 'lucide-react';
...
export default function ContactContent() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'Le contenu de nos articles est protégé par les droits d\'auteur d\'Afrique Tech Hub. Vous pouvez citer de cours extraits en ajoutant obligatoirement un lien hypertexte direct vers notre article d\'origine. Toute reproduction intégrale sans autorisation écrite préalable est strictement interdite.'
    },
    {
